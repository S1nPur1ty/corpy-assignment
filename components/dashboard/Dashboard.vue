<template>
    ...
    <div class="flex flex-col gap-6 h-full">
      ...
      <ul class="flex flex-wrap gap-6 text-sm font-medium text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400">
          ...
          <li class="border-b-2 border-blue-600">
              <a href="#" aria-current="page" class="inline-block py-3 text-blue-600 rounded-t-lg active">
                数値データ
              </a>
          </li>
          <li class="">
              <a href="#" class="inline-block py-3 rounded-t-lg hover:text-gray-600">
                画像データ
              </a>
          </li>
          <li class="">
